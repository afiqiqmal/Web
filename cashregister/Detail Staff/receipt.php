...
<body>
    ...
    if($user->isLoggedin())
    {
        ...
        {            
            ...
            if($user->count() == 1)
            {
                ...
                if(!Session::exists('products') && !Session::exists('receipt-sales'))
    ...
    <?php 
        ...
        $query->execute(array(Session::get('receipt-id')));
        if($query->rowCount()>0){
            ...
            <div class="list">
                ...
                <?php
                    ...
                    { 
                        foreach(Session::get('products') as $cart_itm){
                            ...
                            echo "<td>".$cart_itm['goods_price']." (".$cart_itm['goods_discount']."%)</td>";
                            echo "<td>".$cart_itm['goods_qty']."</td>";
                            echo "<td>".($cart_itm["goods_price"]-($cart_itm['goods_price']*$cart_itm['goods_discount']/100))."</td>";
                            echo "</tr>";
                ...
                <tfoot>
                    ...
                    <tr>
                        ...
                        ?>
                        <td colspan="3">PAY</td>
                        <td class="bold"><?php echo number_format($amount,2); ?></td>
                    </tr>
                    <tr>
                        <td colspan="3">BALANCE</td>
                        <td class="bold"><?php echo number_format($amount-$final_total,2); ?></td>
                    </tr>
                </tfoot>
                </table>
            </div>
    ...
    <script type="text/javascript">
        function createPopup(data){
            var mywindow=window.open("","new div","height=800,width=1300");
            mywindow.document.write("<html><head><title></title>");
            mywindow.document.write("<link rel=\"stylesheet\" href=\"../detail/receipt.css\" type=\"text/css\" media=\"print\" />");
            mywindow.document.write("<link rel=\"stylesheet\" href=\"../detail/bootstrap/bootstrap-overrides.css\" type=\"text/css\" media=\"print\" />");
            mywindow.document.write("<link rel=\"stylesheet\" href=\"../detail/bootstrap/bootstrap-responsive.css\" type=\"text/css\" media=\"print\" />");
            mywindow.document.write("<link rel=\"stylesheet\" href=\"../detail/bootstrap/bootstrap.css\" type=\"text/css\" media=\"print\" />");
            mywindow.document.write("<link rel=\"stylesheet\" href=\"../detail/layout.css\" type=\"text/css\" media=\"print\" />");
            mywindow.document.write("<link rel=\"stylesheet\" href=\"../detail/elements.css\" type=\"text/css\" media=\"print\" />");                                                                        
        ...
        $('#print').click(function(){
           createPopup(document.getElementById("receipt").innerHTML);
        });
    </script>
    <script>
...
<?php
        ...
        Session::delete('receipt-em');
        Session::delete('receipt-cust');
        Session::delete('receipt-sales');
