...
<body>
    ...
    <div class="content">
        ...
        <div id="main-stats">
                <div class="row-fluid">
                    <h2 class="title" style="margin:10px 0 10px 10px;"><i class="fa fa-truck"></i> Items</h2>
                </div>
                ...
                <div class="table-wrapper products-table section">
                    ...
                    <div class="row-fluid filter-block">
                        <div class="span10 pull-right">    
                            <input type="text" class="span4 search global_filter" id="global_filter" placeholder="Item Index Global Search" style="padding-right:0px">   
                            ...
                            <a href="inventory.php?item=new&tkn=add&inv=<?php echo md5('3');?>" class="btn btn-success pull-right">
                                <i class="fa fa-plus"></i>
                                ADD ITEMS
                            </a>
                            <button class="btn btn-info pull-right" disabled="disabled" id="bar-view">
                               BARCODES
                            </button>
                            <a href="items-order.php" class="btn btn-info pull-right" >
                               ORDER
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="row-fluid">
                        <form action='../barcode.php' method='post' id='barcode-view'>
                        <table class="table table-hover table-bordered display dataTable" id="items_list">
                            <thead>
                                <tr>
                                    <th class="span1"><input type="checkbox" name="checkall" id="checkall"/></th>
                                    <th class="span2">Items Code</th>
                                    <th class="span3">Items Name</th>
                                    <th class="span2">Category</th>
                                    <th class="span1">Quantity</th>
                                    <th class="span1">Inventory</th>
                                    <th class="span1"></th>
                                </tr>
                            </thead>
                            <tbody>
    ...
    <script type="text/javascript">
        ...
        $(".select-filter").change(function(){
            var a = $(this).val();
                var str;
                if(a=="1") str="Item Code Index";
                if(a=="2") str="Item Name Index";
                if(a=="3") str="Date Added Index";
                if(a=="4") str="Quantity Index";
            ...
            function filterColumn ( i ) {
                $('#items_list').DataTable().column( i ).search( 
                    $('#col'+i+'_filter').val()
                ).draw();
            }
            function filterGlobal () {
                $('#items_list').DataTable().search( 
                    $('#global_filter').val()
                ).draw();
            }
            $(document).ready(function() {
                var table = $('#items_list').DataTable({
                  "oLanguage": {
                ...
                $("#items_list thead tr th:nth-child(2)").click();
