                                ...
                                ?>
                                    <div id="main-stats">
                                        ...
                                        <ul class="breadcrumb" style="margin-bottom:0px;">
                                          <li><i class="fa fa-home"></i><a href="../"> Dashboard</a><span class="divider">></span></li>
                                ...
                                ?>
                                    ...
                                    <div id="pad-wrapper">
                                        <div class="row-fluid">
                                            ...
                                            <table class="table-report table table-bordered" id="total-profit">
                                                <thead>
                                                    <tr>
                                                        <td colspan="2" class="span6"><h4>Total Gain</h4></td>
                                                        <td colspan="2" class="span6"><h4>Total Loss</h4></td>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    <tr>
