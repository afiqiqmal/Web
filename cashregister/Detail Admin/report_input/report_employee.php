                    ...
                    <?php
                        if(Input::exists()){
                                if($typereport == 'detailed'){
                                    ...
                                    $sql = DB::getInstance()->get('tbl_employee',array('user_id','=',Input::get('op_select')));
                                    $emname = $sql->result()->fname;
                                ...
                                ?>
                                    <div id="main-stats">
                                        <div class="row-fluid">
                                            <h2 class="title" style="margin:10px 0 10px 10px;"><i class="fa fa-bar-chart"></i><?php  echo ucwords($typereport) ?> Report - <?php echo ucwords($emname)?></h2>
                                        </div>
                                        <ul class="breadcrumb" style="margin-bottom:0px;">
                                          ...
                                          <li><a href="report_employee.php?rep=<?php echo $typereport ?>&type=<?php echo $type ?>"> Report input : <?php  echo ucwords($typereport).' '.ucwords($type) ?> Report</a><span class="divider">></span></li>
                                            ...
                                            <table class="table-report table table-bordered" id="report-list">
                                                ...
                                                <tbody >
                                                    <?php
                                                        ...
                                                        $disp = 'SELECT b.sales_id,sale_time,payment_amount,SUM(goods_qty),cust_id
                                                        ...
                                                        $query->execute(array(Input::get('op_select'),$first,$last));
                                                        if($query->rowCount()>0){
                                                            while($r = $query->fetch(PDO::FETCH_NUM)){
                                                                echo "<tr class='click'>";
                                                                    ...
                                                                    echo "<td>".$r[3]."</td>";
                                                                    if($r[4]=='null')
                                                                        echo "<td>Not Register</td>";
                                                                    else
                                                                        echo "<td><a href='../cust-profile.php?id=".base64_encode(base64_encode($r[4]))."'>".$r[4]."</a></td>";
                                                                echo "</tr>";
                                                                echo "<tr class='rowdetail'>";
                                                                    echo "<td colspan='6' style='padding:0'>";
                                                                        echo "<table class='table-report inner table table-bordered'>";
                                                                            ...
                                                                            $rowd = 'SELECT a.goods_id,c.goods_name,c.goods_category,a.goods_qty,a.unit_price,a.goods_discount
                                                                            ...
                                                                            $query1->execute(array($r[0],$first,$last));
                                            ...
                                            <table class="table-report table table-bordered" id="report-list">
                                                ...
                                                <tbody>
                                                    <?php
                                                        ...
                                                        $disp = 'SELECT b.sales_id,sale_time,e.cust_fname,payment_amount,SUM(goods_qty),d.fname
                                                                FROM tbl_sales_item a,tbl_sales b,tbl_sales_payment c,tbl_employee d,tbl_employee e
                                                                WHERE a.sales_id = b.sales_id 
