                    ...
                    <?php
                        if(Input::exists()){
                                if($typereport == 'detailed'){
                                    ...
                                    $sql = DB::getInstance()->get('tbl_cust',array('cust_id','=',Input::get('op_select')));
                                            ...
                                            <table class="table-report table table-bordered" id="report-list">
                                                ...
                                                <tbody >
                                                    <?php
                                                        ...
                                                        $disp = 'SELECT b.sales_id,sale_time,payment_amount,payment_type,SUM(goods_qty),d.fname
                                                                FROM tbl_sales_item a,tbl_sales b,tbl_sales_payment c,tbl_employee d
                                                                ...
                                                                echo "<tr class='rowdetail'>";
                                                                    echo "<td colspan='6' style='padding:0'>";
                                                                        echo "<table class='table-report inner table table-bordered'>";
                                                                            ...
                                                                            $query1->execute(array(Input::get('op_select'),$r[0],$first,$last));
                                                ...
                                                <tbody>
                                                    <?php
                                                        ...
                                                        $disp = 'SELECT b.sales_id,sale_time,e.cust_fname,payment_amount,SUM(goods_qty),d.fname
                                                                FROM tbl_sales_item a,tbl_sales b,tbl_sales_payment c,tbl_employee d,tbl_cust e
                                                                WHERE a.sales_id = b.sales_id 
                                                                AND b.user_id = d.user_id 
