...
<body>
    ...
    <div class="content">
        ...
        <div id="main-stats">
                <div class="row-fluid">
                    <h2 class="title" style="margin:10px 0 10px 10px;"><i class="fa fa-truck"></i> Supplier</h2>
                </div>
                ...
                <div class="table-wrapper users-table section">
                    ...
                    <div class="row-fluid filter-block">
                        <div class="span10 pull-right">    
                            <input type="text" class="span4 search global_filter" id="global_filter" placeholder="Supplier Index Global Search" style="padding-right:0px">   
                                    ...
                                    <div class="body">
                                        ...
                                        <div class="form">
                                            <select class="select-filter" style="width:200px">
                                                <option value="1">Supplier ID</option>
                                                <option value="2">Supplier Name</option>
                                                <option value="3">Email</option>
                                                <option value="4">Contact Number</option>
                                            </select>
                                            <input style="width:200px;"type="text" data-column="1" placeholder="Supplier ID Index" class="column_filter" id="col1_filter">
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="row-fluid">
                        <table class="table table-hover table-bordered display dataTable" id="supplier-list">
                            ...
                            <tbody>
                                ...
                                echo '<tr >';
                                    echo '<td><input type="checkbox" name="check[]" id="check" value="'.base64_encode(base64_encode($r->supplier_id)).'" /></td>';
                                    echo'<td>'.$r->supplier_id.'</td>';
                                    echo'<td>';
                                        echo'<img src="../images/default_pic.jpg" class="img-circle avatar hidden-phone" />';
                                        echo'<a href="sup-profile.php?"id='.base64_encode(base64_encode($r->supplier_id)).' class="name">'.$r->supplier_name.'</a>';
                                        echo'<span class="subtext">&nbsp;</span>';
                                    echo'</td>';
                                    echo'<td><a href="tables.html#">'.$r->supplier_email.'</a></td>';
                                    echo'<td class="align-right">'.$r->supplier_tel.'</td>';
                                echo '</tr>';
                                }
                                ?>
                            </tbody>
    ...
    <script type="text/javascript">
        ...
        $(".select-filter").change(function(){
            var a = $(this).val();
                var str;
                if(a=="1") str="Supplier ID Index";
                if(a=="2") str="Supplier Name Index";
            ...
            function filterColumn ( i ) {
                $('#supplier-list').DataTable().column( i ).search( 
                    $('#col'+i+'_filter').val()
                ).draw();
            }
            function filterGlobal () {
                $('#supplier-list').DataTable().search( 
                    $('#global_filter').val()
                ).draw();
            }
            $(document).ready(function() {
                ...
                $("#supplier-list thead tr th:nth-child(2)").click();
