                                    ...
                                    if($query->rowCount()>0){
                                        while($r = $query->fetch(PDO::FETCH_NUM)){
                                            echo "<tr>";
                                                ...
                                                echo "<td>".$r[2]."</td>";
                                                echo "<td>".$r[3]."</td>";
                                                echo "<td><a href='view-receipt.php?view=".Crytion::encryt64(Session::get('select_cust'))."&time=".$r[0]."&sale=".$r[4]."'>View Receipt</a></td>";
                                            echo "</tr>";
                                        }
                                    }
                              ...
                              if($final_total != 0){
                                  echo '<div class="panel panel-info">';
                                    ...
                                    echo '<form name="pay-form" method="post" action="updatecart.php?return_url='.$current_url.'">';
                                      ...
                                      echo '</select></td></tr>';
                                      echo '<tr><td><input type="text" class="span" name="amount" placeholder="Amount" value="'.($final_total-$pay).'" ></td>';
