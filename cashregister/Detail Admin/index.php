            ...
            <div id="main-stats">
                <div class="row-fluid stats-row" style="text-align:center">
                    <?php
                        ...
                        $query = $con->query("Select Count(*) from tbl_visitor");
                        $data=$query->fetch(PDO::FETCH_NUM);
                        $row=$data[0];
                        echo '<div class="span3 stat last">';
                        echo '<div class="data">';
                        ...
                        $query = $con->query("Select Count(*) from tbl_goods");
                        $data=$query->fetch(PDO::FETCH_NUM);
                        $row=$data[0];
                        echo '<div class="span3 stat last">';
                        echo '<div class="data">';
                        ...
                        $query = $con->query("Select SUM(payment_amount) from tbl_sales_payment");
                        $data=$query->fetch(PDO::FETCH_NUM);
                        $row=$data[0];
                        echo '<div class="span3 stat last">';
                        echo '<div class="data">';
             ...
             <div id="main-stats">
                <div class="row-fluid stats-row" style="text-align:center">
                    <?php
                        ...
                        $query = $con->query("Select Count(*) from tbl_sales");
                        $data=$query->fetch(PDO::FETCH_NUM);
                        $row=$data[0];
                        echo '<div class="span3 stat last" >';
                        echo '<div class="data" >';
                        ...
                        $query = $con->query("Select Sum(goods_qty) from tbl_sales_item");
                        $data=$query->fetch(PDO::FETCH_NUM);
                        $row=$data[0];
                        echo '<div class="span3 stat last">';
                        echo '<div class="data">';
                        ...
                        echo 'Items Sold';
                        echo '</div>';
                        echo '<span class="date">Sold Last Month</span>';
                        echo '</div>';
