          ...
          <section id="main" role="main">
               ...
               <aside id="leftbar" class="pull-left">
                    <div class="sidebar-container">
                         <?php
                        //Main Menu bar
                        Editor::navbar(array('index','typo','socialwall','widget','table','form','UI','chart','photo','sample'),'photo-open-default'); 
                        ?>
                    </div>
            ...
            <aside id="rightbar" class="pull-right">
               ...
               <section id="content" class="container">
                    <header class="p-header">
                         <h2 class="p-title">Photo Gallery - Default</h2>
                    </header>
                    
                    <p>Click on thumbnails to preview.</p>
