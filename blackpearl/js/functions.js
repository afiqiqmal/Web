$(document).ready(function(){
    /*----------------------
        Title Changer
    -----------------------*/
    document.title = " MHI DASHBOARD RESPONSIVE BETA V1.0 ";
    ...
    /* --------------------------------------------------------
        Sidebar Toggle padding: 4px 0 0 7px;
    -----------------------------------------------------------*/
    (function(){

	function handler1() {
        $(this).closest('aside').addClass('toggled').wrapInner("<div class='test' />").children(".test").animate({
		width: '230px'
	    }, 100, function(){
		$(this).closest('aside').find('.shadowed').css('cssText','display:block !important').fadeIn(150);
        ($(this).closest('aside').find('.sidebar-toggle').attr("id")=="leftbar-toggle")?$(this).closest('aside').find('.sidebar-toggle').css("left","230px"):$(this).closest('aside').find('.sidebar-toggle').css("right","230px");
	    $(this).closest('aside').find('.sidebar-toggle').css('padding','1px 0 0 7px');
        });
        $(this).closest('aside').find('.sidebar-container').css('cssText','width:230px !important');
	    $(this).closest('aside').find('.sidebar-toggle').one("click", handler2);
	}
	function handler2() {
	    $(this).closest('aside').find('.shadowed').fadeOut(150, function(){
		$(this).closest('aside').removeClass('toggled').find('.test').animate({
		    width: '15px'
		}, 100);
        ($(this).closest('aside').find('.sidebar-toggle').attr("id")=="leftbar-toggle")?$(this).closest('aside').find('.sidebar-toggle').css("left","15px"):$(this).closest('aside').find('.sidebar-toggle').css("right","15px");
		$(this).closest('aside').find('.sidebar-toggle').css('padding','4px 0 0 7px');
...
$(window).load(function(){
    ...
    -------------------------------------------------------------*/
$(document).ready(function(){
    $('#ptcheckadd').click(function(){
        $address = $('#address').val();
        $pcode = $('#pcode').val();
        $state = $('#state').val();
        if ($(this).is(':checked')) {
            $('#ptaddress').val($address);
            $('#ptpcode').val($pcode);
            $('#ptstate').val($state);
        }
        else{
    ...
    $('#ptcheckadd2').click(function(){
        $address = $('#address').val();
        $pcode = $('#pcode').val();
        $state = $('#state').val();
        if ($(this).is(':checked')) {
            $('#ptaddress2').val($address);
            $('#ptpcode2').val($pcode);
            $('#ptstate2').val($state);
        }
        else{
